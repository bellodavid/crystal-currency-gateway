...
const TradingInterface = ({ pool, onTrade }: TradingInterfaceProps) => {
    ...
    return (
      <Card className="glass-card p-8">
        <div className="text-center space-y-6">
          <div className="w-20 h-20 bg-gradient-to-r from-orange-500 to-purple-500 rounded-full flex items-center justify-center mx-auto">
  ...
  return (
    <div className="space-y-6">
        ...
        <div className="space-y-3">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="p-3 bg-white/5 rounded-lg">
              ...
              <div className="text-xl font-bold text-white">{balance.USDT.toLocaleString()}</div>
            </div>
            <div className="p-3 bg-white/5 rounded-lg">
              <div className="text-xs text-gray-400 mb-1">{pool.baseCurrency} Available</div>
              <div className="text-xl font-bold text-white">{(balance[pool.baseCurrency] || 0).toLocaleString()}</div>
            </div>
          </div>
        </div>
      </Card>
      ...
      <Card className="glass-card p-6">
        <div className="flex items-center justify-between mb-4">
          <h3 className="text-lg font-semibold text-white">{pool.baseCurrency}/USDT Pool</h3>
      ...
      <Card className="glass-card p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <Button
            ...
            size="lg"
            className="h-24 bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white group"
          >
            <div className="flex flex-col items-center space-y-2">
              <TrendingUp className="w-8 h-8 group-hover:scale-110 transition-transform" />
              <div>
                <div className="font-bold">Buy USDT</div>
                <div className="text-sm opacity-90">Pay with {pool.baseCurrency}</div>
              </div>
            </div>
          </Button>
          ...
          <Button
            ...
            size="lg"
            className="h-24 bg-gradient-to-r from-red-500 to-red-600 hover:from-red-600 hover:to-red-700 text-white group"
          >
            <div className="flex flex-col items-center space-y-2">
              <TrendingDown className="w-8 h-8 group-hover:scale-110 transition-transform" />
              <div>
                <div className="font-bold">Sell USDT</div>
                <div className="text-sm opacity-90">Receive {pool.baseCurrency}</div>
              </div>
            </div>
          </Button>
        </div>
