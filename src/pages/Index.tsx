            ...
            <Card className="glass-card p-4">
              ...
              <div className="space-y-2 text-sm text-gray-400">
                <div className="flex items-start space-x-2">
                  <div className="w-5 h-5 bg-crystal-500/20 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                    <span className="text-crystal-400 text-xs font-bold">1</span>
                  </div>
                  <p>Enter trade amount and review dynamic fees</p>
                </div>
                <div className="flex items-start space-x-2">
                  <div className="w-5 h-5 bg-crystal-500/20 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                    <span className="text-crystal-400 text-xs font-bold">2</span>
                  </div>
                  <p>Connect wallet and confirm transaction</p>
                </div>
                <div className="flex items-start space-x-2">
                  <div className="w-5 h-5 bg-crystal-500/20 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                    <span className="text-crystal-400 text-xs font-bold">3</span>
                  </div>
                  <p>Verified merchant processes your trade</p>
                </div>
                <div className="flex items-start space-x-2">
                  <div className="w-5 h-5 bg-crystal-500/20 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                    <span className="text-crystal-400 text-xs font-bold">4</span>
                  </div>
